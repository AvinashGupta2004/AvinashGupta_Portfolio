function ServiceCard(props) {
  return (
    <div className="min-w-[18rem] border-1 border-white lg:flex bg-white flex-col justify-center items-center gap-2 rounded-md shadow-[0_0_5px_rgba(0,0,0,0.1)] p-4 transition duration-300 linear hover:border-blue-600">
